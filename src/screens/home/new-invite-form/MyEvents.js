...
import MyPhoto from 'ping/assets/createnew/myevents/men.jpg';
  ...
  const { control, errors, setValue, reset, handleSubmit } = useForm({
    ...
    return (
      ...
      >
        ...
        >
          <View  >
          <Text style={[textStyles.bigBold,{left:heightPercentageToDP('3')} ]}>{state.event}</Text>
          </View>
        ...
        <View style={{left:heightPercentageToDP('1.5'),textAlign: 'center',marginTop: heightPercentageToDP('-6')}}>
          ...
          <TouchableOpacity >
          <LocationNearMeIcon style={{left:heightPercentageToDP('42'),marginTop: heightPercentageToDP('-2.2')}} size={heightPercentageToDP(3)} color={colors.darkGrey} />
          </TouchableOpacity>
          </View>
          ...
          <View  style={{left:heightPercentageToDP('42'),marginTop: heightPercentageToDP('-3')}} size={heightPercentageToDP(3)} >
          <TouchableOpacity>
          ...
          <TouchableOpacity >
            <Text style={[textStyles.bigRegular, { color: colors.darkGrey }, {left:heightPercentageToDP('37'),marginTop: heightPercentageToDP('-3')}]}>See all</Text>
          </TouchableOpacity>
          </View>
        ...
        <View >
          ...
          <TouchableOpacity >
            <Text style={[textStyles.bigRegular, { color: colors.primary }, {left:heightPercentageToDP('30'),marginTop: heightPercentageToDP('-3')}]}>See all invites</Text>
          </TouchableOpacity>
        </View>
